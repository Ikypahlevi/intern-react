...
export default function AdminSidebar({ isOpen, setIsOpen }) {
  ...
  return (
    <aside
      className={`fixed lg:sticky left-0 top-0 h-screen w-64 bg-white lg:border-r-[3px] border-r-[3px] border-black z-50 flex flex-col justify-between overflow-y-auto font-bubble transition-transform duration-300 lg:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
    >

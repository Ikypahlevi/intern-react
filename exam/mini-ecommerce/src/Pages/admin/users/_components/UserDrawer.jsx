  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-xl bg-white border-l-[3px] border-black shadow-[-10px_0_0_#000] z-50 flex flex-col transform transition-transform duration-300">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-comic text-xl text-black uppercase font-black">
                {isEdit ? "Cập Nhật Hồ Sơ ✏️" : "Thêm Tài Khoản Mới ⚡"}
              </h2>
              <p className="font-bubble text-sm font-bold text-gray-800">Cấu hình hồ sơ, quyền hạn và trạng thái</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        {/* Form Body */}
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 flex flex-col gap-6 bg-gray-50">
        ...
        <div className="bg-white border-t-[3px] border-black p-4 flex items-center justify-end gap-4">
          <button 
            type="button"
            onClick={onClose}
            className="px-6 py-2 bg-gray-200 text-black border-[2px] border-black font-comic text-sm uppercase font-black shadow-[2px_2px_0px_#000] hover:bg-gray-300 transition-colors"
          >
            Hủy Bỏ
          </button>
          <button 
            ...
            className="px-8 py-2 bg-green-500 text-black border-[2px] border-black font-comic text-sm uppercase font-black shadow-[2px_2px_0px_#000] hover:bg-green-600 transition-colors flex items-center gap-2"
          >

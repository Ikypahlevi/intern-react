    ...
    <>
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="max-w-xl space-y-3">
            ...
            <p className="text-xs sm:text-sm font-medium text-gray-300 font-bubble">
              Siêu ưu đãi bùng nổ - Giảm tới 50% toàn bộ Boxset, ấn phẩm manga
              One Piece, Jujutsu Kaisen, Chainsaw Man, Berserk, Frieren và phụ
              kiện Obi, Artbook độc quyền!
            </p>
      ...
      <section className="mb-8 comic-border bg-white p-3 shadow-comic">
        <div className="flex items-center justify-between gap-4 overflow-x-auto text-xs font-bubble font-black tracking-wider uppercase py-1 scrollbar-hide">
          ...
          <span className="px-3 py-1 hover:bg-gray-100 comic-border-sm border-transparent hover:border-black transition-all cursor-pointer">
            SHUEISHA
          </span>
          <span className="px-3 py-1 hover:bg-gray-100 comic-border-sm border-transparent hover:border-black transition-all cursor-pointer">
            KODANSHA
